...
/** Main activity showing listView
 * @author Hugh
 */
public class MainActivity extends Activity {
    ...
    /** Allows for user to access business creation screen
     *
     * @param v CREATE button
     */
    ...
    /** Allows for user to click on listView item and expand it
     *
     * @param business
     */
